...
class Stack {
    ...
    public void stackUp(Game g) {
        Cell temp = new Cell(g);
        temp.prox = top;
        top = temp;
        temp = null;
        size++;
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < op; i++) {
            ...
            switch (str.charAt(0)) {
                ...
                case 'R':
                    System.out.println("(R) " + stack.unstack().getName());
                    break;
            }
        }
